...
{
	None = 0,
	WindowClose, WindowResize, WindowLoseFocus, WindowMoved,
...
#define EVENT_CLASS_GET_NAME(EnumValue) virtual const char* GetName() const override { return #EnumValue; }
