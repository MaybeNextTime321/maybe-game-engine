...
namespace Maybe
{
	...
	public:
		...
		virtual int GetCategoryFlags() const override { return (int)EventType::WindowResize; }
	...
	public:
		...
		virtual int GetCategoryFlags() const override { return (int)EventType::WindowClose; }
	};
	...
	public:
		...
		virtual int GetCategoryFlags() const override { return (int)EventType::AppTick; }
	};
	...
	public:
		...
		virtual int GetCategoryFlags() const override { return (int)EventType::AppUpdate; }
	};
	...
	public:
		...
		virtual int GetCategoryFlags() const override { return (int)EventType::AppRender; }
	};
